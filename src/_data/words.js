module.exports = (() => {
  return [
    ...
    },
    {
      term: 'concretize',
      definition:
        'to make something concrete or specific. To make substantial, real, or tangible; to represent or embody a concept through a particular instance or example.',
      cite: {
        href: 'https://www.wordnik.com/words/concretize',
        name: 'Wordnik',
      },
    },
  ].sort((a, b) => {

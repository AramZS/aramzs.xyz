---
title: >-
  Here's how I know more people read my personal blog via RSS then any
  other platform
tags:
  - Nifty Show and Tell
  - code
  - amplifeeds
  - rss
date: '2025-06-25T16:00:00.000-04:00'
cover_image: rss-zs-favicon-2400-1200.png
cite:
  name: >-
    Here's how I know more people read my personal blog via RSS then any
    other platform
  ...
  href: >-
    https://aramzs.github.io/open-source/2025/06/25/rss-is-the-way-most-people-read-my-blog.html
description: I am very happy to find out that more people read my blog on RSS than anywhere else, but how to figure that out and technically measure RSS readers proved difficult.
---
...
{% image 'src/images/rss-stats-in-context.png' 'Overall stats of pageviews per page on my site' 'center-in-text' %}

And when I break it out as a source it constitutes over a third of my traffic.

{% image 'src/images/rss-stats.png' 'Stats on RSS as a standalone source' 'center-in-text' %}

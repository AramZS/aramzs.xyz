...
tags:
  ...
  - media
  - journalism
date: '2026-04-13T18:09:35.000-04:00'
cite:
  name: The Internet's Most Powerful Archiving Tool Is in Peril
  author: Kate Knibbs
  href: >-
    https://www.wired.com/story/the-internets-most-powerful-archiving-tool-is-in-mortal-peril/
archive: web-archive-is-in-danger-ai-blocking.wacz
linkInternal: true
---
...
[Users of the internet also need to band together and archive sites for themselves](https://aramzs.xyz//microblogs/if-the-federal-government-hosts-something-important-to-you-archive-it-yourself/). If it is important, we can't rely on the Internet Archive capturing it anymore. We need to use [in-browser tools to capture it ourselves](https://webrecorder.net/archivewebpage/). I did it with this article here (you can find the link at the bottom of the page), though WIRED might have preferred if I didn't.
